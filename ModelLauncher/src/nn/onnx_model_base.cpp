    ...
    : modelPath_(modelPath)
{
    ...
    if (provider == OnnxProviders::CUDA) {  // strcmp(provider, OnnxProviders::CUDA.c_str()) == true strcmp(provider, "cuda") // (providerStr == "cuda")
    ...
    else if (provider == OnnxProviders::CPU) {  // strcmp(provider, OnnxProviders::CPU.c_str()) == true) (providerStr == "cpu") {
        // "cpu" by default
    }
    else
    {
